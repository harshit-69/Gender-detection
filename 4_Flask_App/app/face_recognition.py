...
model_svm =  pickle.load(open(r"C:\Users\Harshit\Downloads\FaceRecognition_Flask-main (1)\2_Train_FaceRecognition_with_ML\model\model_svm.pickle",mode='rb')) # machine learning model (SVM)
pca_models = pickle.load(open(r"C:\Users\Harshit\Downloads\FaceRecognition_Flask-main (1)\2_Train_FaceRecognition_with_ML\model\pca_dict.pickle",mode='rb')) # pca dictionary
